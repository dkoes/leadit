  ...
  if(NOT RDKIT_LIBRARIES)
    ...
    if(FILEPARSERS_LIB)
      ...
      find_library(RDGENERAL_LIB NAMES RDGeneral RDKitRDGeneral
                                 HINTS ${RDKIT_LIBRARY_DIR})
      find_library(CHEMREACTIONS_LIB NAMES ChemReactions RDKitChemReactions 
	                    HINTS ${RDKIT_LIBRARY_DIR})
      ...
      set (RDKIT_LIBRARIES ${FILEPARSERS_LIB} ${SMILESPARSE_LIB}
               ${GRAPHMOL_LIB} ${RDGEOMETRYLIB_LIB} ${RDGENERAL_LIB}
	      ${SUBGRAPHS_LIB} ${DATASTRUCTS_LIB} ${DEPICTOR_LIB} ${CHEMREACTIONS_LIB} ${SUBSTRUCTMATCH_LIB}
              )
    endif()
    if(RDKIT_LIBRARIES)
