...
public:
	KSamplePartitioner(unsigned kc = 8, unsigned ks = 5, CenterChoice ch = KSamplePartitioner::AveCenter, unsigned stop = 32768): kcenters(kc), ksamples(ks), stopPartitionSize(stop) {}
